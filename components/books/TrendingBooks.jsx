...
const TrendingBookItem = ({ book, onPress }) => (
  ...
  >
    ...
    <Text className="font-semibold text-white" numberOfLines={1}>{book.title}</Text>
    <Text className="text-xs text-white opacity-80" numberOfLines={1}>{book.author}</Text>
  ...
  return (
    <View className="mt-6 pb-6">
      <View className="px-4 flex-row justify-between items-center mb-4">
        <Text className="text-lg font-bold">Trending Boooks</Text>
