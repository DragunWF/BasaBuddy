    ...
    >
      <BottomSheetView className="flex-1 px-6 pt-4">
        ...
        <Text className="text-sm text-gray-600 text-center leading-5 mb-8">
          Resetting your profile will permanently erase all your personal information, including your name, username, birthday, reading history, achievements, and system settings. Any exported data that you haven't saved will also be lost. This action cannot be undone.
        </Text>
